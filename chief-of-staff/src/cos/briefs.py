...
4. `mail(limit=25)` — flag anything unread or flagged that plausibly needs me.
...
**What changed since last time** — with source links.
...
3. Read memory/commitments.md for what is already tracked.
